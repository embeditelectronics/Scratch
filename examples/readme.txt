...
1. rpisoc_analog_ex moves scratch the cat back and forth according to the voltage reading (from 0 to 5V) on RPiSoC pin 15[5]. In my video example I plug a potentiometer into that pin to use as a knob.
