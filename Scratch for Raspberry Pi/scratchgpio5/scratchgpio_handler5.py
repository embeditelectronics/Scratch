    ...
    def run(self):
        ...
        ### Check for AddOn boards being declared
                ...
                if 'sensor-update' in self.dataraw:
                    ...
                    if self.vFindValue('analogRead'):
                        print "found analog read in first spot"
        ...
        ### Check for Broadcast type messages being received
                ...
                if 'broadcast' in self.dataraw:
                    ...
                    if self.bFind('analogread'):
                        print 'found analog read broadcast'
                        outputall_posA = self.dataraw.find('analogRead')
                        sensor_valueA = self.dataraw[(outputall_posA+10):].split()
                        print "analog port 1: "
                        print sensor_valueA
